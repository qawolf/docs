...
A workspace on [triggers](/triggers/overview) configures this as a deployment trigger with a generative action. See [Generative flow selection](/triggers/overview#generative-flow-selection).
