...
- **A deployment trigger** matching those preview deploys, with a generative action. See [Generative flow selection](/triggers/overview#generative-flow-selection).
