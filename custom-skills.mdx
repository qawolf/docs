...
- Team conventions, such as [structuring flow headers around Arrange-Act-Assert (AAA)](/test-automation#structure-the-flow-header-around-arrange-act-assert-aaa)
