...
<Check>
  If your workspace still has unpaused legacy triggers, stop here and read [Migrate from legacy triggers](/triggers/migrate-from-legacy-triggers) first. The first trigger you create cuts the whole workspace over.
</Check>
