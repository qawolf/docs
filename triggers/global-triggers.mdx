...
If your workspace still runs legacy triggers, read [Migrate from legacy triggers](/triggers/migrate-from-legacy-triggers) before creating your first global trigger. [Legacy triggers](/legacy/legacy-triggers) describes the older model on its own terms.
