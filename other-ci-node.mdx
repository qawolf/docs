...
sidebarTitle: "Any CI with Node.js"
---

Use this guide if your CI system supports Node.js and doesn't have a dedicated QA Wolf integration page. If your CI system can't run Node.js, use [Any CI without Node.js](/other-ci-webhook) instead.

## Requirements

- Access to a QA Wolf workspace with at least one environment configured
- A CI pipeline that runs after a successful deployment, with Node.js 18 or later
