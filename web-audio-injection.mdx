...
<Note>
  WAV format is recommended. Store your audio file in team storage and reference it via `process.env.TEAM_STORAGE_DIR`. See [Use files in flows](/use-files-in-flows) for instructions.
</Note>
