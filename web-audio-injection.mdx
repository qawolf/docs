...
<Note>
  WAV format is recommended. Store your audio file in team storage and reference it via `process.env.TEAM_STORAGE_DIR`. See [Upload files](/Uploading-manually) for instructions.
</Note>
