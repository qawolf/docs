...
**Declarative launch** <Badge color="green">Recommended</Badge> — pass `launch: true` to use the default startup, or an options object to customize it. Either way, QA Wolf starts the browser or app before your callback runs, and the callback receives the platform object ready to use.
