  ...
  <Tab title="Claude Code">
    <Steps>
      ...
      <Step title="Authenticate and approve">
        When you select **Authenticate** a browser window will open with instructions to log in or sign up.  When you select **Authenticate** a browser window will open with instructions to log in or sign up.
