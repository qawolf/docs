...
This endpoint feeds [legacy triggers](/legacy/legacy-triggers). A workspace on [global triggers](/triggers/global-triggers) reports deploys through [deployment events or `deployment.reportStatus`](/triggers/report-deployments), which this endpoint does not reach.
