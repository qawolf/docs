...
This endpoint feeds [legacy triggers](/legacy-triggers/overview). A workspace that has migrated reports deploys through [deployment events or `deployment.reportStatus`](/triggers/report-deployments), which this endpoint does not reach.
