...
This endpoint feeds [legacy triggers](/legacy-triggers/overview). A workspace on [global triggers](/triggers/overview) reports deploys through [deployment events or `deployment.reportStatus`](/triggers/report-deployments), which this endpoint does not reach.
