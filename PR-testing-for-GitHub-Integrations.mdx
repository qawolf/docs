...
sidebarTitle: "PR testing on GitHub"
---

This page describes the older per-environment trigger model. A workspace on [global triggers](/triggers/global-triggers) tests pull requests with a deployment trigger that matches preview deploys; see [Migrate from legacy triggers](/triggers/migrate-from-legacy-triggers).
