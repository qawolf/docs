...
<Note>
  These are skills stored in your QA Wolf workspace for QA Wolf's AI. To install QA Wolf skills in an external coding agent, use the [QA Wolf MCP guide](/qawolf-mcp).
</Note>
