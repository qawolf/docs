...
<Note>
  Store your barcode image in team storage and reference it via `process.env.TEAM_STORAGE_DIR`. See [Upload files](/Uploading-manually) for instructions. The image must encode the exact value your test expects.
</Note>
