...
<Steps>
  <Step title="**Kick-off** (by day 5)">
    ...
    **Attending**
    ...
    | Day-to-day champion | QA team lead |
    | Engineers, PMs, and members of your QA team you want involved |  |
  </Step>
  <Step title="**Product Tour** (by day 5)">
    ...
    **Attending**
    ...
    | Your team | Our team |
    | --- | --- |
    | PM or engineering lead familiar with what needs testing | QA team lead |
    |  | Test outliner |
  </Step>
  <Step title="**First Test Plan Review** (by day 15)">
    ...
    **Attending**
    ...
    | Your team | Our team |
    | :-- | :-- |
    | PM or engineering lead | QA team lead |
    |  | Test outliner |
  </Step>
