...
Tags are used to group flows for scheduled runs and to control execution order in run rules. See [Tags](/qawolf/Use-tags-effectively) for guidance on how to apply them.
