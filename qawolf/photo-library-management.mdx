...
icon: "image"
description: "QAWolf can add, list, and delete photos in the device photo library. Use this to set up known state before a test or verify that your app saved photos correctly."
---
