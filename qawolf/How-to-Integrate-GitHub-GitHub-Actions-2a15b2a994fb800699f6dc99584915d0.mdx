...
- If either applies, see the [SDK Integration Guide](/qawolf/How-to-Integrate-any-build-with-the-QA-Wolf-SDK-2db5b2a994fb8043be61f06f025d9c63) for an alternative.
</Danger>

<AccordionGroup>
<Accordion title="How to: Integrate QA Wolf and GitHub Actions">
<Steps>
<Step>
Open the `Workspace name` dropdown in QA Wolf and click **Workspace Settings**.

<Frame>
<img src="/images/integrating-with-CI-CD/image-1.png"/>
</Frame>
</Step>
<Step>
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-2.png"/>
</Frame>
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-3.png"/>
</Frame>
</Step>
<Step>
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-4.png"/>
</Frame>
</Step>
<Step>
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-5.png"/>
</Frame>
...
<Accordion title="How to: Install the action">
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-6.png"/>
</Frame>
</Step>
<Step>
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-7.png"/>
</Frame>
</Step>
<Step>
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-8.png"/>
</Frame>
</Step>
<Step>
Copy either the [example](/qawolf/How-to-Integrate-GitHub-GitHub-Actions-2a15b2a994fb800699f6dc99584915d0) from the Action’s Marketplace page or the example below into your workflow file (usually .github/workflows/deploy.yml). Replace the values in `deployment-type` and `deployment-url` with your actual values.
