...
The <Icon icon="chevron-down" /> icon next to **Create flow** opens a drawer with **Outline flows**, which starts an outlining session across a whole application at once — see [Product Mapping](/qawolf/Map-your-app-s-workflows).
