...
If you'd prefer to write flows manually, see [Create flows in the IDE](/qawolf/Create-a-new-flow).

<Note>
  This page covers AI creation inside QA Wolf. To create flows from Claude Code, Codex, or another coding agent, see [Use QA Wolf from your coding agent](/qawolf/coding-agents/get-started).
</Note>
...
The <Icon icon="chevron-down" /> icon next to **Create flow** opens a drawer with **Outline flows**, which starts an outlining session across a whole application at once — see [Create a coverage outline](/qawolf/Map-your-app-s-workflows).
...
For manual debugging, see [Debug tests & flows](/qawolf/Debug-tests-and-flows).
