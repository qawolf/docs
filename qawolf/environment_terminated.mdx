...
A `warning` field behaves the same way here as on [webhooks/deploy_success](/qawolf/deploy-success#response) — present when the request needed a workspace and didn't name one, never changing the outcome.
