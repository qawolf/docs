...
<Note>
  Run History in the Flows tab only shows results from scheduled runs. See [Scheduling flows](/qawolf/Scheduling-flows) to set up a schedule.
</Note>
...
- On a schedule — see [Scheduling flows](/qawolf/Scheduling-flows)
