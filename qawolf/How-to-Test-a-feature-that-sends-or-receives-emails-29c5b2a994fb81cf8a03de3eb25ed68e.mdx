...
<AccordionGroup>
    <Accordion title="The Email Allowlist">
    ...
    <Accordion title="How to: Change the default email">
...
<Tip>
Any email address used with `getInbox` must be on your team’s [Email Allowlist](/qawolf/How-to-Test-a-feature-that-sends-or-receives-emails-29c5b2a994fb81cf8a03de3eb25ed68e).
</Tip>
