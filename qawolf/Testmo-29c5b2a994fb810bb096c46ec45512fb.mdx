...
description: "Integrate QA Wolf with Testmo to centralize automated test results and reporting. Customers configure Testmo. QA Wolf uses the provided credentials to sync results and enable the integration."
