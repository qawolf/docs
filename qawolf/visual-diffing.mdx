...
description: "To automate visual comparisons, use toHaveScreenshot.
"
icon: "scan"
---

<Info>
  This page covers web and mobile web. For native iOS and Android apps, see [Assert visual appearance on native mobile](#).
</Info>
...
- Mobile web uses the same Playwright API as desktop web. Use a distinct name for the first argument of `toHaveScreenshot` (e.g. `nav-header-web`,`nav-header-mobile-web`) so all baselines are stored separately.
