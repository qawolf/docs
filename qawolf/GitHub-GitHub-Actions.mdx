...
<Tip>
  If your team self-hosts GitHub Enterprise Server without internet access, or has disabled GitHub Actions by policy, use the [QA Wolf CI SDK](/qawolf/z-archive/Integrate-with-the-QA-Wolf-SDK) instead.
</Tip>
