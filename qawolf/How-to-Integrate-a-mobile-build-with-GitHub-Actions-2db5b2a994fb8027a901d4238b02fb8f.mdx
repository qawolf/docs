...
3. [Artifact naming conventions](/qawolf/How-to-Start-testing-mobile-apps-2da5b2a994fb8037bb15e410d7366fd2) are defined for your environments

Mobile triggers must be enabled for your workspace by QA Wolf before test runs will execute.
</Tip>

<AccordionGroup>
<Accordion title="Overview: How the GitHub Actions integration works">
...
You provide the [artifact basename](/qawolf/How-to-Start-testing-mobile-apps-2da5b2a994fb8037bb15e410d7366fd2) when uploading. QA Wolf applies the file extension automatically based on the uploaded file.

</Accordion>
<Accordion title="How to: Add QA Wolf actions to your workflow">
...
Make sure the workflow has access to the **QAWOLF_API_KEY** secret.
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-17.png"/>
</Frame>
</Step>
<Step>
Choose **Integrations**,
...
<Frame>
<img src="/images/integrating-with-CI-CD/image-18.png"/>
</Frame>
</Step>
</Steps>
</Accordion>
...
```yaml highlight={1-25} expandable
