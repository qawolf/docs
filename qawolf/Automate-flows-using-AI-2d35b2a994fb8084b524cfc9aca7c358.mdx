...
Four entry points on the **Flows** tab create a new flow: two hand the work to the agent, and two drop you into the IDE to write it yourself.
...
Both open the AI chat panel, ready for you to describe the flow you want. Working with the agent one prompt at a time is [guided creation](/qawolf/getting-the-most-out-of-automate#guided-creation).

**In the IDE**

- <Icon icon="square-plus" /> in the flows list toolbar — opens a menu with **New flow** and **New folder**
- <Icon icon="code" /> **IDE** — hover over the left sidebar to expand it, then select **IDE** and create the file from the explorer

<Frame>
  ![The New flow and New folder menu in the flows list toolbar](/images/flows-list-toolbar.png)
</Frame>

See [Create flows in the IDE](/qawolf/Create-a-new-flow-2c15b2a994fb802193a5c05e0219eb59) for writing the test code by hand.
