...
- <Icon icon="square-plus" /> — in the flows list toolbar, which opens a menu with **New flow** and **New folder**
...
Below **Create flow**, the left sidebar switches between the three views on the **Flows** tab:

- <Icon icon="grid-2x2" /> **All flows** — the coverage map of every flow in the environment
- <Icon icon="code" /> **IDE** — the file tree and code editor, for writing flows by hand — see [Create a new flow](/qawolf/Create-a-new-flow-2c15b2a994fb802193a5c05e0219eb59)
