...
description: "Learn the structure of every QA Wolf flow — the AAA framework, imports, the flow wrapper, launch styles, and callback parameters."
---

If the agent generated a flow for you and you want to understand what it produced, here's what each part does. If your team has written Playwright or Appium tests before, QA Wolf flows will look familiar. The selectors, interactions, and assertions work the same way. What's different is the wrapper around them.
