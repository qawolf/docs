...
For files, see [Attachments](/qawolf/libraries/emails/how-to/send-attachments). For the full `sendMessage(...)` shape, see the [Mail Reference](/qawolf/libraries/emails/api-reference/mail).