...
await saveEnvironmentVariable("LAST_LOGIN_USER", "wolf@example.com");
```
...
For exact exports and option shapes, see the [Testkit API Reference](/qawolf/libraries/testkit/api-reference/index).
