---
title: "Get Started"
description: "Use @qawolf/testkit helpers for OTPs, QR codes, screenshots, environment variables, and network setup."
...
- Read [Entry Points](/qawolf/libraries/testkit/core-concepts/entry-points) to choose the right import.
- Read [Client Model](/qawolf/libraries/testkit/core-concepts/client-model) if you are wiring a runner or local harness.
- Use [API Reference](/qawolf/libraries/testkit/api-reference/index) for exact option shapes.
