...
Some exports are placeholders until QA Wolf runs the flow. They are typed for authoring, then wired to real runner dependencies at execution time.
...
For exact option shapes and defaults, use the platform reference pages: [Web](/qawolf/libraries/flows/api-reference/web), [Android](/qawolf/libraries/flows/api-reference/android), and [iOS](/qawolf/libraries/flows/api-reference/ios).