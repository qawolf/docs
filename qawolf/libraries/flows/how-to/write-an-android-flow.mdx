...
For the full Android launch shape and app resolution rules, see the
[Android Reference](/qawolf/libraries/flows/api-reference/android).
...
For device API details, see the
[Android Reference](/qawolf/libraries/flows/api-reference/android).
