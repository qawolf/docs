...
For the full iOS launch shape and app resolution rules, see the [iOS Reference](/qawolf/libraries/flows/api-reference/ios).
...
For other simulator or device helpers, use the [iOS Reference](/qawolf/libraries/flows/api-reference/ios).