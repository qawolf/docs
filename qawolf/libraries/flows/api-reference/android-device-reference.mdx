...
<Note>
  The command timeout (1 minute by default) bounds playback. For audio longer than a minute, pass `durationSeconds`. See [Microphone injection](/qawolf/android-audio-injection) for a full walkthrough.
</Note>
