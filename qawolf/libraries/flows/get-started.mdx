...
- Read [Flow Model](/qawolf/libraries/flows/core-concepts/flow-model) for the two startup styles.
- Use [Write a Web Flow](/qawolf/libraries/flows/how-to/write-a-web-flow), [Write an Android Flow](/qawolf/libraries/flows/how-to/write-an-android-flow), or [Write an iOS Flow](/qawolf/libraries/flows/how-to/write-an-ios-flow) for platform examples.
- Keep [API Reference](/qawolf/libraries/flows/api-reference/index) nearby for exact option shapes.
