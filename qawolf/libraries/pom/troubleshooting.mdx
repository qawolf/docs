...
Cause: The page object is not registered, or its hook override isn't detected — see [Entry points and page hooks](/qawolf/libraries/pom/api-reference/index#entry-points-and-page-hooks) for how hook collection actually works.
