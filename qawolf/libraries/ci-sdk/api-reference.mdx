---
title: "API Reference"
description: "Reference for the @qawolf/ci-sdk TypeScript package, including installation, initialization, and available methods for triggering runs from CI."
---
