...
<Info>
  This page covers web only. For native iOS and Android apps, see [Assert visual appearance on native mobile](#).
</Info>
...
- To inspect a visual diff result in the editor, collapse the test block — an <Icon icon="images" /> icon will appear in the right gutter of that line. Click it to open the Image Diff panel, where you can view the **Diff**, **Expected**, **Actual**, and **Compare** tabs for each named snapshot.
  <Frame>
    ![Visual Diffing](/images/visual-diffing.png)
  </Frame>
