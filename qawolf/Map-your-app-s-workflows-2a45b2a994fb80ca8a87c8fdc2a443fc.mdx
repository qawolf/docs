...
Every outlining session is saved as a job. Reopen one from <Icon icon="zap" /> **Automate jobs** to continue the conversation or review what it outlined — see [Track and review agent jobs](/qawolf/automate-jobs).
