...
<Steps>
  <Step>
    ...
    <Note>
      The drawer is the supported way to start outlining. The other create options can produce flows too, but only **Outline flows** runs the agent in outlining mode.
    </Note>
  </Step>
  <Step>
    A new outlining session opens with a live browser panel in the center. The agent will ask you to confirm the URL you want to explore, or you can type your own instructions into the chat box.

    <Frame>
      ![Outlining session](/images/outlining-session.png)
    </Frame>
  </Step>
  <Step>
