...
## Review the flows the agent outlined

Every outlining session becomes a job. Open it from <Icon icon="zap" /> **Automate jobs** to see the flows it produced and inspect them one at a time.

<Frame>
  ![The review view for an outlining job](/images/automate-jobs-review.png)
</Frame>

The left panel lists every flow in the job, marked with whether it passed or needs attention. Select one to read its **Outline**, and use **Retry flow** on anything that failed. See [Track and review agent jobs](/qawolf/automate-jobs) for the full review workflow.

Publishing adds the flows to your coverage outline, creating the group structure and empty flow files in the IDE.
