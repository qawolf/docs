...
description: "Use prebuilt GitHub Actions to upload mobile build artifacts to QA Wolf and trigger test runs from your existing workflows."
sidebarTitle: "GitHub Actions"
description: "Use the QA Wolf GitHub Actions to upload mobile build artifacts and trigger test runs directly from your existing workflows."
---
