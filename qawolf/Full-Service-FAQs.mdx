...
You can monitor the [status of failed tests](/qawolf/Interpret-run-results) in the Runs tab.
...
We also support PR testing for [GitHub](/qawolf/PR-testing-for-GitHub-Integrations) and [GitLab](/qawolf/PR-testing-for-GitLab-Integrations) through our [Scheduled Runs](/qawolf/Scheduling-flows). You can ask your QA Lead to increase or decrease your test runs to best fit your process.
