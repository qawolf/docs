...
description: "Single Sign-On (SSO) allows your team to authenticate with QA Wolf using your organization's identity provider (IdP), such as Okta, OneLogin, or Microsoft Entra ID."
icon: "shield-check"
---
...
<Steps>
  ...
  <Step title="Confirm successful login">
...
Access to QA Wolf is controlled through your identity provider.

To grant access:

- Assign a user or group to the QA Wolf application.

To remove access:

- Remove the user or group from the QA Wolf application.
