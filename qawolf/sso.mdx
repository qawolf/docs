...
<Steps>
  <Step title="Go to Workspace Settings → Organization">
    Go to **Workspace Settings → Organization**.
  </Step>
  <Step title="Grant the SSO Admin role">
    Grant the **SSO Admin** role to the user who is going to follow these instructions.
  </Step>
  <Step title="Sign out and back in">
    Sign out and back in after their role is updated.
  </Step>
</Steps>
...
<Steps>
  <Step title="Sign in to QA Wolf">
    Sign in to QA Wolf.
  </Step>
  <Step title="Navigate to Workspace Settings → Organization">
...
From the same **Workspace Settings → Organization** page, click **Set up SSO**. This page contains the configuration values required for your identity provider.
...
<Steps>
  <Step title="Create a new application">
    Create a **new application** for QA Wolf.
  </Step>
