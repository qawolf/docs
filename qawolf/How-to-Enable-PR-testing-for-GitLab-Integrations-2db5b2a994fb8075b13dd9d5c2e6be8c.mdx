...
description: "PR testing runs QA Wolf tests against preview environments before changes are merged. Tests run when a merge request enters your merge pipeline, and results are reported back to GitLab as a pipeline result and (optionally) a merge request status."
---
...
<AccordionGroup>
<Accordion title="How to: Ensure merge requests deploy preview environments">
...
<Accordion title="How to: Trigger QA Wolf tests from merge request pipelines">
...
- The preview environment URL is available as PREVIEW\_URL when this job runs.
...
<Accordion title="How to: Require QA Wolf tests before merge">
...
<Accordion title="How to: Verify your PR testing setup">
<Steps>
