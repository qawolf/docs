...
- `.qawolf/.gitignore` — ignores the contents of `.qawolf/`, such as flows pulled from the platform. It also covers run artifacts written to the default `.qawolf/output/`.
...
For the full flow authoring surface, see the [@qawolf/flows Top-Level Reference](/qawolf/libraries/flows/api-reference/top-level).
