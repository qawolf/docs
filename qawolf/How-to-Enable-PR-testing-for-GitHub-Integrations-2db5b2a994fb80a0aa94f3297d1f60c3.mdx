...
<Tip>
Your [GitHub integration](/qawolf/How-to-Integrate-GitHub-GitHub-Actions-2a15b2a994fb800699f6dc99584915d0) and deploy notifications must already be set up.
</Tip>
...
<AccordionGroup>
<Accordion title="How to: Add a default passing PR check">
...
<Accordion title="How to: Trigger QA Wolf tests in the merge queue">
