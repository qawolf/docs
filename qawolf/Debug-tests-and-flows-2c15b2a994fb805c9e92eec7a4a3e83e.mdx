...
<Note>
  Run History only shows results from scheduled runs. Manual runs from the editor or Flows tab do not appear here. See [How Runs work](/qawolf/Run-a-flow-or-suite-2a25b2a994fb8014b164d7ad2efd5ddel) for a full explanation of run types.
</Note>
