...
![Automate Flows Details](/images/automate-flows-details.png)
...
The **Details** tab shows the tags and readiness status assigned to the current flow. Both fields can be edited directly from this tab using the <Icon icon="pencil" /> icon next to each
