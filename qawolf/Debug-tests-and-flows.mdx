...
**Elements** — lets you enter a locator or CSS selector to highlight matching elements in the live browser. Useful for verifying selectors while writing or debugging a flow. See [Element picker](/qawolf/Use-the-Elements-picker) for more details.
...
<Note>
  Run History only shows results from scheduled runs. Manual runs from the editor or Flows tab do not appear here. See [How Runs work](/qawolf/Run-a-flow-or-suite) for a full explanation of run types.
</Note>
