...
<Tip>
  Any email address used with `getInbox` must be on your team’s [Email Allowlist](/qawolf/Using-emails-in-tests-29c5b2a994fb81cf8a03de3eb25ed68e#the-email-allowlist).
</Tip>
