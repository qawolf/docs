...
<Steps>
  ...
  <Step>
    ...
    b. To change the default mail address in the allowlist, hover over the email you'd like to set as the default, then click the <Icon icon="ellipsis" /> icon and select Make default.
