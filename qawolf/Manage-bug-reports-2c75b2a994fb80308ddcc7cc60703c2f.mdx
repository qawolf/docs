...
icon: "bug-play"
sidebarTitle: "Manage bug reports"
---
...
<Steps>
  ...
  <Step>
    Click the **Name** field to open a dropdown of existing maintenance reports. As you type, the list autocompletes to help you find a match.
