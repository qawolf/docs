---
title: "How to: File, review & edit bug reports"
---
...
<AccordionGroup>
<Accordion title="Overview: Get to know the bug report tab">
...
- Use the **Open** and **Closed** tabs to switch between active and resolved reports.
    <Frame>
    <img src="/images/execution-scheduling-bugs-and-maintenance/image-37.png"/>
    </Frame>

- Use the **Search** bar to filter by report name. Use the <Icon icon="filter"/> icon to filter by report **Priority** or **Creator is me**.
    <Frame>
    <img src="/images/execution-scheduling-bugs-and-maintenance/image-38.png"/>
    </Frame>
</Accordion>
<Accordion title="How to: File a bug report">
<Steps>
<Step>
...
<Frame>
<img src="/images/execution-scheduling-bugs-and-maintenance/image-39.png"/>
</Frame>
</Step>
<Step>
...
- If the flow has only non-blocking bugs, and at least one flow in the run fails all three attempts, the run ends as *Needs investigation*. The environment’s status will appear with the <Icon icon="circle" iconType="solid" color="yellow"/> icon on both the **Flows** and **Runs** tabs.
</Note>
<Tip>
...
<Frame>
<img src="/images/execution-scheduling-bugs-and-maintenance/image-40.png"/>
</Frame>
</Tip>
</Accordion>
<Accordion title="How to: Review or edit an existing bug report">

- From the **Bugs** tab, find the bug report you’d like to open and click on it.
    <Frame>
    <img src="/images/execution-scheduling-bugs-and-maintenance/image-41.png"/>
    </Frame>
- The only field you can change here is the **Priority** field. All other fields are read-only.
</Accordion>
<Accordion title="How to: Clear bug reports">
...
<Frame>
<img src="/images/execution-scheduling-bugs-and-maintenance/image-42.png"/>
</Frame>
</Step>
<Step>
...
<Frame>
<img src="/images/execution-scheduling-bugs-and-maintenance/image-43.png"/>
</Frame>
</Step>
</Steps>
</Accordion>
<Accordion title="How to: Update the diagnosis of a test failure">
...
<Frame>
<img src="/images/execution-scheduling-bugs-and-maintenance/image-44.png"/>
</Frame>
</Accordion>
</AccordionGroup>