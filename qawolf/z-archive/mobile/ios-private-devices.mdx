...
Private devices can do anything [allowlisted devices](/qawolf/z-archive/mobile/ios-allowlisted-devices) can. You can share the UDIDs of private devices and skip resigning when that is needed for your tests.
