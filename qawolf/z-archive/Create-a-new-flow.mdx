---
title: "Create flows in the IDE"
description: "Create flow files and folders and write test code manually in the QA Wolf IDE."
hidden: true
---

If you'd prefer to have AI create and edit flows for you, see [Create flows with AI](/qawolf/z-archive/Automate-flows-using-AI).
...
<Note>
  QA Wolf lints your code as you type. See [Debug tests & flows](/qawolf/z-archive/Debug-tests-and-flows) if you encounter errors.
</Note>
