...
This is a different way to work with QA Wolf than [QA Wolf's in-app AI](/qawolf/getting-the-most-out-of-automate), which runs inside the QA Wolf platform itself, or [the QA Wolf CLI](/qawolf/local-execution/authenticate), a separate command-line tool for authenticating and running flows — no AI involved.
...
<Steps>
  ...
  <Step title="Verify the finished flow">
    ...
    See [Run status](/qawolf/Glossary#run-status) for the possible outcomes.
  </Step>
</Steps>
