...
For prompting practices that cut down on failures in the first place, see [Test Automation](/qawolf/getting-the-most-out-of-automate).
...
- Review run status across all flows — see [Reviewing run results](/qawolf/Interpret-run-results)
- Run flows manually — see [How runs work](/qawolf/Run-a-flow-or-suite)
- Apply tags and manage readiness — see [Tags](/qawolf/tags)
- Open a flow in the editor to write or edit code — see [Create flows in the IDE](/qawolf/Create-a-new-flow)
