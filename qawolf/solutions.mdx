...
<CardGroup cols={2}>
  ...
  <Card title="Audio" icon="ear" href="/qawolf/audio-injection">
    Inject audio and capture speak output into mobile test flows.
  </Card>
  ...
  <Card title="Sensors" icon="circle-gague" href="/qawolf/android-location-mocking">
