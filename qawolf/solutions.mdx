...
<CardGroup cols={2}>
  ...
  <Card title="Device Hardware & Compatibility" icon="microchip" href="/qawolf/network-connectivity">
    Test network conditions, connectivity, and hardware compatibility.
  </Card>

  <Card title="Multi-User, Multi-Device" icon="arrow-right-left" href="/qawolf/Pass-data-between-flows-29d5b2a994fb801080bce743ab552931">
