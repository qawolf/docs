...
icon: "stethoscope"
sidebarTitle: "Diagnose a failing flow"
---
...
You'll typically access these tools from the Investigation view or the **Run History** tab in the IDE.
...
<Note>
  Run History is also available in the IDE — select a flow and click the **Run History** tab in the right panel.
</Note>
