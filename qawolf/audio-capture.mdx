---
title: "Audio capture"
description: "Record audio from the device speaker during a test and compare it against a reference file to verify playback."
sidebarTitle: "iOS"
---
...
// Start recording
const startResult = await device.startSpeakerRecording(driver);
...
import Sample from '/snippets/flows/audio-capture.mdx';
