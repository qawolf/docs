...
**For bugs** — [file a bug report](/qawolf/Manage-bug-reports). When you file a bug report, the severity is used to display warnings about the safety of a given release.
