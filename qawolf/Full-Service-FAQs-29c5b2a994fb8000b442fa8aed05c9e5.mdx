...
### How can I monitor QA Wolf’s progress building tests?
...
<Steps>
  ...
  <Step>
    Hover over your team name in the All Flows above to see the <Icon icon="square" />  icon, then click it to get the <Icon icon="square-check" /> icon. Below the list to the right, the number to the right of the <Icon icon="route" /> icon shows the total number of flows, and the number to the right of the <Icon icon="code-commit" /> icon shows the total number of tests that meet the filter criteria.
