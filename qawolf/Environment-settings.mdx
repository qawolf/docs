...
In the QA Wolf platform, an [environment](/qawolf/Glossary) corresponds to a specific version of your app, such as development, staging, or production.
...
<Tip>
  These can also be updated from the **Flows** tab.
</Tip>