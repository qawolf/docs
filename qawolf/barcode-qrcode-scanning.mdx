...
icon: "scan-qr-code"
description: "QAWolf can inject barcode and QR code detections directly into any app that uses iOS's built-in barcode scanning. The app receives the injected data exactly as if the camera had seen and decoded a real code — including the barcode type, decoded value, and position coordinates."
---
