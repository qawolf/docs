---
title: "iOS Barcode and QR code scanning"
description: "Inject barcode and QR code data into any iOS app to test scanning workflows without a physical camera."
sidebarTitle: "iOS"
---
...
const cleanup = await device.injectBarcode(driver, bundleId, {
