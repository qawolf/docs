...
<Steps>
  ...
  <Step>
    Return to QA Wolf **Integrations**, and generate your **QAWOLF\_API\_KEY** by clicking the <Icon icon="clipboard" /> icon to the right of **API Key** under **API Access**.
  ...
  <Step>
    Type QAWOLF\_API\_KEY in **Name** and paste the value you copied above into **Secret**.
  </Step>
  <Step>
