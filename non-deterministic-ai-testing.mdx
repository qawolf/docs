---
title: "Non-deterministic AI assertions"
description: "Validate AI-generated responses using a judge model and assert on a structured JSON verdict."
---

For a built-in assertion that needs no API key, see [Assert on the meaning of generated text](/semantic-assertions). This page covers calling a judge model yourself.
