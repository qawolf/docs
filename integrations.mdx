...
Testing your deploys takes two pieces. Your pipeline notifies QA Wolf that you deployed, and a [trigger](/triggers/overview) decides which flows run. The pages below cover the first piece.

## Notify QA Wolf of your deploys

Pick the one that matches where your code lives and how you deploy.

- **[PR testing](/deployment-testing/pr-testing)** — what testing every pull request needs, on any of the paths below.
