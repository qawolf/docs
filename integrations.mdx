...
- **[GitHub](/deployment-testing/github)** — your repositories are on GitHub and something creates a deployment record for each deploy, whether your own workflow or a provider such as Vercel.
...
- **[CircleCI](/deployment-testing/circle-ci)** — you deploy from CircleCI and want to know which of the three above it uses.
