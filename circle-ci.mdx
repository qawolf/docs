...
If your deployments run through CircleCI, add a job that notifies QA Wolf once a deploy succeeds. Deployment triggers are configured for your main environment per your QA Wolf contract, so contact your QA Wolf representative before setting this up.

## Requirements

- Access to a QA Wolf workspace
- Admin access to your CircleCI project
- At least one QA Wolf environment configured with a deployment trigger
