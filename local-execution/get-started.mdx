...
The CLI runs flows that already exist. Create coverage first through [Quick start](/quick-start) — `qawolf flows pull` needs an environment that already has flows in it.
