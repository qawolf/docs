...
- `.qawolf/.gitignore` — ignores the contents of `.qawolf/`, such as flows pulled from the platform. It doesn't cover run artifacts in `qawolf-output/`.
