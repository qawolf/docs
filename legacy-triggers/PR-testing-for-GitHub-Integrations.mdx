...
This page describes [legacy triggers](/legacy-triggers/overview). A workspace that has migrated tests pull requests with a deployment trigger matching preview deploys; see [Migrate from legacy triggers](/triggers/migrate-from-legacy-triggers).
