---
title: "Testing Electron apps"
description: "Test a desktop app built with Electron from a QA Wolf flow."
sidebarTitle: "Electron apps"
---
...
For the full Electron launch shape, see the [Web API Reference](/libraries/flows/api-reference/web).