...
**For bugs** — [file a bug report](/qawolf/z-archive/Manage-bug-reports). When you file a bug report, the severity is used to display warnings about the safety of a given release.

**For flow maintenance** — [file a maintenance report](/qawolf/Manage-maintenance-reports). This prevents the flow from being executed in runs until it is fixed, which resolves the investigation state without requiring an immediate fix.
