...
Outlining is designed for breadth — capturing an app's testable surface quickly. For flows that need individual attention, use [AI flow creation](/qawolf/z-archive/getting-the-most-out-of-automate-2) to turn them into tests one at a time with more targeted prompts.
