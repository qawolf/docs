...
- Some features cannot be tested on a resigned app — see [Allowlisted devices](/qawolf/z-archive/mobile/ios-allowlisted-devices).
- Some tests need devices that are not shared with other customers — see [Private devices](/qawolf/z-archive/mobile/ios-private-devices).
