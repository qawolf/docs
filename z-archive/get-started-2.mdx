...
This is a different way to work with QA Wolf than [QA Wolf's in-app AI](/qawolf/z-archive/getting-the-most-out-of-automate-2), which runs inside the QA Wolf platform itself, or [the QA Wolf CLI](/qawolf/local-execution/authenticate), a separate command-line tool for authenticating and running flows — no AI involved.
