...
<Steps>
  ...
  <Step>
    ...
    a. **Outline** — what the flow covers<br /> b. **Video** — a recording of the run<br /> c. **Code** — the test code the agent wrote, whether it passed, and a control to run it again<br /> d. **Details** — the run's metadata
  </Step>
</Steps>
...
For prompting practices that cut down on failures in the first place, see [Test Automation](/qawolf/z-archive/getting-the-most-out-of-automate-2).
...
- Review run status across all flows — see [Reviewing run results](/qawolf/z-archive/Interpret-run-results)
- Run flows manually — see [How runs work](/qawolf/z-archive/Run-a-flow-or-suite)
- Apply tags and manage readiness — see [Tags](/qawolf/tags)
- Open a flow in the editor to write or edit code — see [Create flows in the IDE](/qawolf/z-archive/Create-a-new-flow)
