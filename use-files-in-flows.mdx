---
title: "Use files in flows"
description: "Upload files to team storage and use them in your flows — test data, images, audio, and anything else a flow reads at runtime."
---
