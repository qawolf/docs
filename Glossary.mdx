...
<Note>
  Older workspaces may still run legacy triggers, which attach to a single environment. See [Legacy triggers](/legacy/legacy-triggers).
</Note>

See [Global triggers](/triggers/global-triggers) for the full model.
